...
async function initialize(db) {
  ...
  await runStaticBatch(db, [
    ...
    `CREATE INDEX IF NOT EXISTS idx_midmonth_snapshots_route_month ON attendance_midmonth_snapshots(route, month, status, cutoff_date DESC, created_at DESC)`,
    `CREATE INDEX IF NOT EXISTS idx_midmonth_snapshot_items_snapshot ON attendance_midmonth_snapshot_items(snapshot_id, status_date, employee_id)`,
